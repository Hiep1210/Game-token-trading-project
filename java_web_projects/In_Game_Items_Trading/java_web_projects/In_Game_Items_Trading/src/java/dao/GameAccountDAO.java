...
public class GameAccountDAO {
        ...
        try {
            ...
            if (con != null) {
                ...
                while (rs.next()) {             //needed even if just 1 row       
                    ...
                    guser = new GameAccount(rs.getInt("game_id"), rs.getString("realname")
                            , username, pass, dob, rs.getString("email"), rs.getString("gender"), rs.getString("avatar"));
                }
                call.close();
                con.close();
            }
    ...
    public static void main(String[] args) {
        GameAccount g = GameLogIn("hung", "hung123");
