...
<body onload="copyDiv()">
    ...
    <nav class="navbar navbar-expand-lg" id="navbar">
        <div class="container-fluid">
            ...
            <a class="navbar-brand col-lg-3" href="#">
                <img src="image/market_csmoney_2.png" alt="Bootstrap" width="200px">
            </a>
                ...
                <div class="container">
                    ...
                    <div class="row" id="item-box">
                        ...
                        <div class="col-lg-2 item-card mt-2 mb-2" id="item-card">
                            <div class="card">
                                <img src="image/item_placeholder.png" class="card-img-top" alt="...">
                                <div class="card-body">
    ...
    <script>
        function copyDiv() {
            var itemBox = document.getElementById("item-card");
            var container = document.querySelector("#item-box");

            for (var i = 1; i < 18; i++) {
                var clone = itemBox.cloneNode(true);
