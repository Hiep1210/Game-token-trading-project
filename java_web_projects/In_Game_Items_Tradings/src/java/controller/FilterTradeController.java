...
@WebServlet(name = "FilterTradeController", urlPatterns = {"/FilterTradeController"})
public class FilterTradeController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String[] ex = request.getParameterValues("exte");
        String printAddButton = "";

        List<GameItems> itemList = GameItemsDAO.filterTrade(typeList, ex, searchName, sortOrder);
